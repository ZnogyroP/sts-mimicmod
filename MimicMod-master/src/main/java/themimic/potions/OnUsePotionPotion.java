...
public abstract class OnUsePotionPotion extends AbstractPotion {
    ...
    public static AbstractPlayer.PlayerClass playerClass = null;

    public OnUsePotionPotion(String id, int potency, PotionRarity rarity, PotionSize shape, PotionEffect effect, Color liquidColor, Color hybridColor, Color spotsColor) {
