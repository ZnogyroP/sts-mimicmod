...
public class HacklesUpgradePower extends BasePower {

    public static final String POWER_ID = makeID("HacklesUpgrade");
    ...
    public HacklesUpgradePower(AbstractCreature owner, int amount) {
