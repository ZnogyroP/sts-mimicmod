...
public abstract class BasePower extends AbstractPower {
    ...
    public BasePower(String id, PowerType powerType, boolean isTurnBased, AbstractCreature owner, AbstractCreature source, int amount, int turns) {
    ...
    public void onCreateIntent(AbstractMonster instance) {

    }

    public void atStartOfTurnPostDrawEnemyPowers(AbstractMonster mo) {
    }
