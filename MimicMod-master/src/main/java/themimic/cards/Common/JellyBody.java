...
public class JellyBody extends BaseCard {
    public static final String ID = makeID(JellyBody.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
