...
import themimic.actions.KinStrikeAction;
import themimic.cards.BaseCard;
import themimic.character.MimicCharacter;
import themimic.util.CardStats;

public class KinStrike extends BaseCard {
    public static final String ID = makeID(KinStrike.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new KinStrikeAction(this, damage, p, m));
    }
