...
import themimic.actions.PsychOutAction;
import themimic.cards.BaseCard;
import themimic.character.MimicCharacter;
import themimic.util.CardStats;

public class PsychOut extends BaseCard {
    public static final String ID = makeID(PsychOut.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new PsychOutAction(damage, magicNumber, p, m));
    }
