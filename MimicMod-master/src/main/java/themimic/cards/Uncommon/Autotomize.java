...
import themimic.powers.AutotomizePower;
import themimic.util.CardStats;

public class Autotomize extends BaseCard {
    public static final String ID = makeID(Autotomize.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new AutotomizePower(p, magicNumber), magicNumber));
    }
