...
public class BrandNewMe extends BaseCard {
    public static final String ID = makeID(BrandNewMe.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public BrandNewMe() {
        ...
        MultiCardPreview.add(this, false, new Eye(), new Teeth(), new Ribs(), new Heart());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new MakeTempCardInHandAction(new Heart().makeCopy(), 1));
    }

    public AbstractCard makeCopy() {
        return new BrandNewMe();
    }
