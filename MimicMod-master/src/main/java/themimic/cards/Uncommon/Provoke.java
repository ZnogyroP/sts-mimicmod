...
public class Provoke extends BaseCard {
    public static final String ID = makeID(Provoke.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new DamageAction(m, new DamageInfo(p, damage, DamageInfo.DamageType.NORMAL), AbstractGameAction.AttackEffect.FIRE));
        addToBot(new ApplyPowerAction(m, p, new AngerPower(m, this.magicNumber), this.magicNumber, false, AbstractGameAction.AttackEffect.NONE));
    }
