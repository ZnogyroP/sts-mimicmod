...
import themimic.actions.LethalEnvyAction;
import themimic.cards.BaseCard;
import themimic.character.MimicCharacter;
import themimic.util.CardStats;

public class LethalEnvy extends BaseCard {
    public static final String ID = makeID(LethalEnvy.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new LethalEnvyAction(m, new DamageInfo(p, damage, DamageInfo.DamageType.NORMAL), p));
    }
