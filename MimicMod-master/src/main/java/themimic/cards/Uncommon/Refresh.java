...
import themimic.actions.IncreaseCostAction;
...
public class Refresh extends BaseCard {
    public static final String ID = makeID(Refresh.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
