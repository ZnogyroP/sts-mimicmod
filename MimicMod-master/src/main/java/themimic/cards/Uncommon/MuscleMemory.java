...
public class MuscleMemory extends BaseCard {
    public static final String ID = makeID(MuscleMemory.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new SelectCardsInHandAction(1, cardStrings.EXTENDED_DESCRIPTION[0], false, false, c -> true, (cards -> cards.forEach(c -> CardModifierManager.addModifier(c, new RetainMod())))));
