...
import themimic.actions.OutreachAction;
...
public class Outreach extends BaseCard implements OnObtainCard {
    public static final String ID = makeID(Outreach.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new OutreachAction(p));
    }
