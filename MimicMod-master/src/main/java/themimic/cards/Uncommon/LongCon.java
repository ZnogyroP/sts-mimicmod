...
import themimic.powers.LongConPower;
import themimic.tags.CustomTags;
import themimic.util.CardStats;

public class LongCon extends BaseCard {
    public static final String ID = makeID(LongCon.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToTop(new ApplyPowerAction(m, p, new LongConPower(m, p, magicNumber), magicNumber, false));
    }
