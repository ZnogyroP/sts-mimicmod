...
public class ElaborateDeception extends BaseCard {
    public static final String ID = makeID(ElaborateDeception.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static final int drawnCards = 3;

    public ElaborateDeception() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new DrawCardAction(drawnCards, new ElaborateDeceptionAction(weakAmt, magicNumber)));
    }
