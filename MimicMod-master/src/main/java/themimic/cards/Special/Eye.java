...
public class Eye extends BaseCard {
    public static final String ID = makeID(Eye.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
