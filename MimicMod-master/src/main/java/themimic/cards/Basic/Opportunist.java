...
import themimic.actions.OpportunistAction;
import themimic.cards.BaseCard;
import themimic.character.MimicCharacter;
import themimic.util.CardStats;

public class Opportunist extends BaseCard {
    public static final String ID = makeID(Opportunist.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new OpportunistAction(damage, block, p, m));
    }
