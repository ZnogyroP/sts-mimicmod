...
import themimic.powers.FrankensteinPower;
import themimic.util.CardStats;

public class Frankenstein extends BaseCard {
    public static final String ID = makeID(Frankenstein.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new FrankensteinPower(p, magicNumber), magicNumber));
    }
