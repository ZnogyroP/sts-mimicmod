...
import themimic.powers.InspirationPower;
import themimic.util.CardStats;

public class Inspiration extends BaseCard {
    public static final String ID = makeID(Inspiration.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
