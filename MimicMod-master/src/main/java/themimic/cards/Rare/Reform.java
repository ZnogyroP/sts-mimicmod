...
import themimic.actions.ReformAction;
import themimic.cards.BaseCard;
import themimic.character.MimicCharacter;
import themimic.util.CardStats;

public class Reform extends BaseCard {
    public static final String ID = makeID(Reform.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ReformAction(this.upgraded));
    }
