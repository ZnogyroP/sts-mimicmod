...
import themimic.powers.GraftPower;
import themimic.util.CardStats;

public class Graft extends BaseCard {
    public static final String ID = makeID(Graft.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new GraftPower(p, magicNumber)));
    }
}
