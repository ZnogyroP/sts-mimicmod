...
import themimic.potions.BasePotion;
import themimic.character.MimicCharacter;
import themimic.potions.SpiritOfAnything;
import themimic.relics.BaseRelic;
import themimic.util.GeneralUtils;
import themimic.util.KeywordInfo;
...
@SpireInitializer
public class TheMimicMod implements
    ...
    public static void initialize() {
        ...
        MimicCharacter.Meta.registerColor();
    }
    ...
    public static void registerPotions() {
        ...
        BaseMod.addPotion(SpiritOfAnything.class, null, null, null, SpiritOfAnything.ID, SpiritOfAnything.playerClass);
    }
    ...
    private static String checkResourcesPath() {
        String name = TheMimicMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        if (!resources.exists()) {
            throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                    ...
                    "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                    "\tat the top of the " + TheMimicMod.class.getSimpleName() + " java file.");
        }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(TheMimicMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        MimicCharacter.Meta.registerCharacter();
    }
